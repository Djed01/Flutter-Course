...
class FiltersScreen extends StatefulWidget{
  const FiltersScreen({super.key, required this.currentFiilters});

  final Map<Filter,bool> currentFiilters;
...
class _FiltersScreenState extends State<FiltersScreen>{
  ...
  void initState(){
    super.initState();
    _glutenFreeFilterSet = widget.currentFiilters[Filter.glutenFree]!;
    _lactoseFreeFilterSet = widget.currentFiilters[Filter.lactoseFree]!;
    _vegetarianFilterSet = widget.currentFiilters[Filter.vegetarian]!;
    _veganFilterSet = widget.currentFiilters[Filter.vegan]!;
  }
